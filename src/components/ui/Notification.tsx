...
function getKindInfo(kind: "success" | "warning" | "error" | "info") {
  if (kind === "success") return { icon: CheckCircleIcon, iconColor: "text-green-500 dark:text-green-400" };
  if (kind === "warning") return { icon: ExclamationCircleIcon, iconColor: "text-yellow-500 dark:text-yellow-400" };
