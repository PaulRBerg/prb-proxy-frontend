...
import { PROXY_ABI, PROXY_ABI_VIEM, REGISTRY_ABI, REGISTRY_ABI_VIEM, SOLIDITY_INTERFACE } from "@/lib/contracts";
import { classNames } from "@/lib/utils";
import { copyToClipboard } from "@/lib/utils";

const tabs = [
  {
    abi: SOLIDITY_INTERFACE,
    href: "#solidity",
    filename: "IPRBProxyRegistry.sol",
    imgUri: "/solidity.png",
    imgSize: "sm",
    language: "solidity",
    mimeType: "text/plain",
  ...
  {
    abi: REGISTRY_ABI_VIEM,
    href: "#viem-registry",
    filename: "IPRBProxyRegistry.ts",
    imgUri: "/viem.png",
    language: "typescript",
    mimeType: "text/plain",
    name: "viem (Registry)",
  ...
  {
    abi: JSON.stringify(REGISTRY_ABI, null, 2),
    filename: "IPRBProxyRegistry.json",
    href: "#json-registry",
    imgSize: "sm",
    imgUri: "/json.svg",
    language: "json",
...
const Abi = () => {
  ...
  return (
    <>
      <Head title="ABI" description="PRBProxy ABIs in various formats" />
                ...
                {({ selected }) => (
                  ...
                  >
                    <Image
                      ...
                      className="mr-2"
                      style={{
                        filter: theme === "dark" ? "invert(1) brightness(1) saturate(0)" : undefined,
                      }}
                    />
                    {tab.name}
                  </div>
