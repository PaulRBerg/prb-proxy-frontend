...
const Home = () => {
  const cards = [
    { id: 1, href: "/deployments", title: "Deployments", subtitle: "Deployed on 10+ chains" },
    { id: 2, href: "/abi", title: "ABI", subtitle: "In any format" },
    {
      id: 3,
      href: "https://github.com/PaulRBerg/prb-proxy",
      title: "Docs",
      subtitle: "Learn more",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="mx-auto mt-6 w-full max-w-screen-lg sm:mt-20">
        <h1 className="text-accent mb-10 text-center text-3xl font-bold sm:text-4xl">{SITE_DESCRIPTION}</h1>
        <dl className="flex flex-wrap justify-center text-center sm:flex-nowrap">
          {cards.map((card) => (
            ...
            >
              <dd className="text-primary text-2xl font-semibold tracking-tight sm:text-3xl">{card.title}</dd>
